...
/// Version: 0.1 - (10/19/21) added text color change functionality
/// </summary>
...
namespace SS
{
    ...
    public partial class SpreadsheetPanel : UserControl
    {
        ...
        /// <summary>
        /// If called changes the text color to green for the specific cell.
        /// Returns true if cell can be found, returns false otherwise.
        /// </summary>
        /// <param name="col"></param>
        /// <param name="row"></param>
        /// <param name="value"></param>
        /// <returns></returns>
        public bool ChangeTextColor(int col, int row, string value)
        {
            drawingPanel.SetCellTextColor(col, row, Color.Green);
            return drawingPanel.SetValue(col, row, value);
        }

        /// <summary>
        /// If called changes the text color to red for the specific cell and its error.
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public bool ChangeTextColorErrorOccured(int col, int row, string value)
        {
            drawingPanel.SetCellTextColor(col, row, Color.Red);
            return drawingPanel.SetValue(col, row, value);
        }

        /// <summary>
        /// If called changes the text color back to the default black for the cell address passed in.
        /// </summary>
        /// <param name="col"></param>
        /// <param name="row"></param>
        /// <param name="value"></param>
        /// <returns></returns>
        public bool ChangeTextColorToDefault(int col, int row, string value)
        {
            drawingPanel.SetCellTextColor(col, row, Color.Black);
            return drawingPanel.SetValue(col, row, value);
        }
        ...
        private class DrawingPanel : Panel
        {
            ...
            private Dictionary<Address, Color> _colors;
            ...
            public DrawingPanel(SpreadsheetPanel ss)
            {
                ...
                _colors = new Dictionary<Address, Color>();
                _ssp = ss;
            }
            ...
            protected override void OnPaint(PaintEventArgs e)
            {
                ...
                foreach (KeyValuePair<Address, String> address in _values)
                {
                    ...
                    if (x >= 0 && y >= 0)
                    {
                        ...
                        //Checks to see if an address in colors exits if so set the cell to the stored color value
                        if (_colors.TryGetValue(address.Key, out Color color))
                        {
                            e.Graphics.DrawString(
                            text,
                            regularFont,
                            new SolidBrush(_colors[address.Key]),
            ...
            /// <summary>
            /// Sets the color of the cells text depending on what we pass in.
            /// </summary>
            /// <param name="col"></param>
            /// <param name="row"></param>
            /// <param name="color"></param>
            public void SetCellTextColor(int col, int row, Color color)
            {
                _colors[new Address(col, row)] = color;
            }
        }
    }
}